...
void Vcore___024root___nba_comb__TOP__2(Vcore___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcore___024root___nba_comb__TOP__2\n"); );
    Vcore__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
void Vcore___024root___eval_nba(Vcore___024root* vlSelf) {
    ...
    if ((7ULL & vlSelfRef.__VnbaTriggered[0U])) {
        Vcore___024root___nba_comb__TOP__2(vlSelf);
