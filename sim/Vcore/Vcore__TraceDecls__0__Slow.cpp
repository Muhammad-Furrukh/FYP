...
void Vcore___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    ...
    }
    {
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(2, "MUL_DIV.state_t", 4, 3, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                "111"};
        tracep->declDTypeEnum(3, "include_pkg::mul_div_oper_t", 8, 4, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"BYTE", "HALF", "WORD"};
        const char* __VenumItemValues[]
        = {"0", "1", "11"};
        tracep->declDTypeEnum(4, "include_pkg::data_size_t", 3, 2, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
